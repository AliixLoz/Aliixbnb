...
const ReservationSidebar: React.FC<ReservationSidebarProps> = ({ property, userId }) => {
    ...
    return (
        <aside className="mt-6 p-6 col-span-2 rounded-xl border border-gray-400 shadow-xl">
            <h2 className="mb-5 text-2xl">${property.price_per_night} la noche</h2>
            ...
            <div onClick={performBooking} className="w-full mb-6 py-6 text-center text-white bg-pink-400 hover:bg-pink-800 rounded-xl">Reservar</div>
